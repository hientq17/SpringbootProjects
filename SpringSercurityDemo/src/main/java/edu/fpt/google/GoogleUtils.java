...
import edu.fpt.service.UserRoleService;
...
public class GoogleUtils {
	...
	public UserDetails buildUser(GooglePojo googlePojo) {
		...
		UserEntity user = userService.findByEmail(googlePojo.getEmail());
		if (user == null) {
			//insert new user(gmail) into database
			UserEntity userEntity = new UserEntity();
			userEntity.setEmail(googlePojo.getEmail());
			userEntity.setPassword(googlePojo.getId());
			userService.save(userEntity);
			//get recently inserted user and insert role to it
